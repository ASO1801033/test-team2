...
class ImageController extends Controller
{
  ...
  //ProfileController@storeにあたる
  public function judgment(Request $req) {
    /*
    ...
    */
    //dd($url);
    return redirect('/image/price');
    //return redirect('/image')->with('success', asset('public/file_images/' . date('Y-m-d_H-i-s').'.jpg'));
    //return redirect('/image')->with('success', asset($url)); //asset($url)で画像にアクセスできる
  }
